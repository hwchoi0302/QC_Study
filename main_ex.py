...
manager = QuantumManager(run_mode="real", optimization_level=2)
...
# ==========================================
print("\n--- Sampler 결과 ---")
counts = manager.run(qc, primitive="sampler", shots=1000)
...
print("\n--- Estimator 결과 ---")
expectation_values = manager.run(
    qc_est, primitive="estimator", observables=[observable], shots=1000
)
